...
class ProjectService {
	...
	updateActivity(activityId, name, budget, beginning, end, projectId) {
		return axios.post(API_URL + "updateActivity", {activityId, name, budget, beginning, end, projectId}, { headers: authHeader() });		
	}
